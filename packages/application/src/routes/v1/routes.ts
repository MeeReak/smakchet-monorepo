...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/v1/application',
            ...
            ...(fetchMiddlewares<RequestHandler>(ApplicationController.prototype.ApplyEvent)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/application',
            ...(fetchMiddlewares<RequestHandler>(ApplicationController)),
            ...(fetchMiddlewares<RequestHandler>(ApplicationController.prototype.findAllApplied)),

            async function ApplicationController_findAllApplied(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/application/:id',
            ...(fetchMiddlewares<RequestHandler>(ApplicationController)),
            ...(fetchMiddlewares<RequestHandler>(ApplicationController.prototype.findAppliedById)),

            async function ApplicationController_findAppliedById(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
