<p align="center"><img src="https://github.com/MeeReak/smakchet-monorepo/assets/156150555/20c5a233-696b-4757-a025-ab0507ccdafe" width="120px"></p>
<h1 align="center">Smakchet</h1>

# User Service

## Overview
User is a service use for manage user profile , add event to favorite , update user profile.
...
```bash
cd smakchet-monorepo/packages/user
```
...
```bash
GET  v1/user          	: show all user.
POST v1/user/:id        : add event to favorite
POST v1/user/favorite   : get user favorite
POST v1/user            : create and add user to db
PUT  v1/user/:id        : Update user profile
GET  v1/user/role       : get role
