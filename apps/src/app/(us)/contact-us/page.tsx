  ...
  const page = () => {
    return (
      <>
        ...
        <div className="w-[1024px] m-auto md:mt-[100px] mt-[20px] relative pt-[90px] ">
          {/* banner */}

          <div className="md:w-full w-[100vw] flex md:flex-row flex-col justify-between md:mb-[90px] space-y-5 md:space-y-0 ">
            <div className="md:w-[60%] w-[100vw] flex flex-col my-auto md:space-y-20  space-y-5">
          ...
          <div className="w-full flex md:flex-row flex-col justify-between gap-y-10 md:gap-y-0 ">
            <div className="md:w-[436px] w-[100vw] h-[320px] bg-white p-5 drop-shadow-md flex flex-col items-center align-middle justify-center space-y-8">
              <ButtonIcon
                className=""
                icon={
                  <svg
            ...
            <div className="md:w-[436px] w-[100vw] h-[320px] bg-white p-5 drop-shadow-md flex flex-col items-center gap-y-5 md:gap-y-0">
              <ButtonIcon
                className=""
                icon={
                  <svg
              ...
              <Typography
                align="center"
                fontWeight="bold"
                className="md:mt-[40px] mt-[10px]"
                fontSize="h3"
              >
                Message Directly
              </Typography>
              <Typography align="center" className="md:mt-[30px] mt-2">
                Message us directly so we can discuss more detail.
              </Typography>
              <Button
                className="md:mt-[50px] border border-black"
                bgColor="primary"
                colorScheme="White"
              >
                Message
          ...
          <div className="md:w-full w-[100vw] md:mt-[50px] mt-5 flex flex-col gap-y-5 ">
            <Typography
              align="center"
              fontWeight="bold"
              fontSize="h3"
            ...
            <div className="md:w-full w-[100vw] h-[493px]">
              <Map
          ...
          <div className="md:w-full w-[100vw] mt-[40px]">
            <Typography align="center" fontWeight="bold" fontSize="h3">
              CONTACT INFORMATION
            </Typography>
            <div className="w-full flex justify-between">
              <div className="md:w-[68%] w-full py-6 px-5">
                <form action="">
                  ...
                  <InputData
                    ...
                    className="md:w-[600px] w-full h-[50px] mt-3 mb-6 bg-[#FFFBFB] px-2"
                  />
                  <br />
                  ...
                  <br />
                  <textarea className="md:w-[600px] w-full h-[154px] mt-3 mb-6 border border-black py-[15px] pl-[20px] rounded-[10px] outline-none bg-[#FFFBFB]"></textarea>
                  <Button bgColor="primary" className="text-center py-3 px-4">
                    Send
                  </Button>
                </form>
              </div>
