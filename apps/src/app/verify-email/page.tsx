    ...
    <div>
      <div className="flex flex-col items-center min-h-screen p-5 bg-gray-200 min-w-screen">
          ...
          <div className="mt-7">
            {verificationStatus === "verifying" ? (
              ...
              <div className="flex flex-col justify-center">
                ...
                <p>If you’re having a problem , Please message us directly through this email : <span className="text-blue-500"><Link href="mailto:smakchet.info@gmail.com">smakchet.info@gmail.com</Link></span></p>
              </div>
            )}
          </div>
        </div>
        ...
        {verificationStatus === "no-token" && (
          <p className="text-red-500">No token found. Please check the URL.</p>
        )}
