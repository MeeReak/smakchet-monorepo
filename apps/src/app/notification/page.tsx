...
const page = () => {
  return (
    ...
    {/* max-[1030px]:p-5 max-[1030px]:pl-[10px] max-w-[1024px] m-auto */}
      <div className="bg-white md:mx-[180px] md:mt-[110px] py-[100px] pl-0 md:pl-9 md:pt-[25px] w-full h-full md:rounded-[10px]">
        {/* Notification header */}
        <Typography  className="pl-9 md:pl-0 md:!text-2xl md:!font-semibold !font-bold !text-base">
          Notification
        </Typography>
