...
const SeacondNarbar = () => {
  return (
    <>
      <div className="flex flex-row items-center justify-evenly h-[70px] max-w-[640px] sm:hidden fixed bottom-0 left-0 right-0  m-auto z-50 bg-opacity-50 backdrop-blur-md bg-white">
        {/* Home */}
        <Link href="/">
          <ButtonIcon
            icon={
        ...
        <Link href={"/user-profile"}>
          ...
          <Image
            ...
            width={30}
            height={30}
            className="rounded-full border-2 border-gray-200 mx-3"
          />
        </Link>
      </div>
    </>
